<template>
    <div style="padding-left: 1rem; padding-right: 1rem; padding-bottom: 1rem;">
        <div class="admin-header">
            ...
            <h1 class="admin-title">Nuevo Examen</h1>
        </div>
        <n-form-item label="Nombre del examen" required>
            <n-input placeholder="Nombre del examen"/>
        </n-form-item>
        <n-form-item label="Objetivo del curso" required>
            <n-input placeholder="Escribe el objetivo de este curso" />
        </n-form-item>
        <n-grid :cols="2">
            <n-gi>
                <n-form-item label="Curso" required>
                    <n-input placeholder="Nombre del curso" />
                </n-form-item>
                <n-form-item label="Versión" required>
                    <n-input placeholder="Versión del examen" />
                </n-form-item>
                <n-form-item label="Evaluador" required>
                    <n-select placeholder="Nombre del evaluador" />
                </n-form-item>
            </n-gi>
        ...
        <n-grid :cols="2">
            ...
            <n-gi style="padding-left: 25px;">
                <n-form-item label="Fechas para verificación de eficiencia" style="width:100%">
                    <n-date-picker type="daterange" clearable style="width: 100%"/>
                </n-form-item>
            </n-gi>
        </n-grid>
        ...
        <div style="width: calc(100% - 1rem); display: flex; justify-content: center; gap: 1rem;">
            <n-button color="#0D5A79" size="large" style="border-radius: 8px" @click="addQuestion">Nueva Pregunta</n-button>
